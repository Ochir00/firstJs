...
function findallallstudentAvaragegrade(allStudent) {
  let a = 0;
  for (let i = 0; i < allStudent.length; i++) {
    let average = findOneStudentAverageGrade(allStudent[i]);
    a = a + average;
  }
  a = a / allStudent.length;
  return a;
}

// function
//   console.log(findOneStudentAverageGrade(students[1]));
  console.log(findallallstudentAvaragegrade(students))
// console.log(findallgender(students[1]));
